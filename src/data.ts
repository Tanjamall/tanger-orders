...
export const initialOrders: Order[] = [
  ...
  { id: 'o3', client: 'Salma B.', phone: '07 01 22 88 44', address: 'Malabata, Tanger', items: [{ productId: 'p2', quantity: 2, unitPrice: 59 }], status: 'Delivered', paymentStatus: 'Paid', assignedTo: 'Saeed', deliveryCharge: 0, otherExpense: 12, createdAt: new Date(Date.now() - 86400000).toISOString(), deliveredAt: new Date().toISOString() },
]
