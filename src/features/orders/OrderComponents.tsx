...
export function OrderCard({ order, products, members, confirmationEmployees, onStatus, onEdit, onDelete }: OrderCardProps) {
  ...
  return <article className={`order-row tone-${tone}`}>
